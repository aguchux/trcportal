                            ...
                            <div className="footer-bottom">
                                ...
                                <div className="social-accounts">
                                    <ul>
                                       ...
                                       <li><Link href={`${siteInfo(settings, "siteInstagram")}`}><i className="fab fa-instagram" /></Link></li>
                                       <li><Link href={`${siteInfo(settings, "siteEmailLink")}`}><i className="fa fa-envelope" /></Link></li>
